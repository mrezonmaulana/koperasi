          ...
          <div class="col-12">
            <div class='card'>
              ...
              <form class='form-horizontal' name='frm' id='frm' method='post' action="<?php echo base_url('masterdata/act_add_supplier'); ?>">
                  <input type='hidden' name='tspid' id='tspid' value='<?php echo $list->tspid;?>'>
                  <div class='card-body'>
                      ...
                      <div class='form-group-row'>
                                ...
                                <div class="col col-12">
                                    <div class='col col-4' style="float:left">
                                        ...
                                        <input type="text" class="form-control" name='nama_supplier' id='nama_supplier' value='<?php echo $list->nama_supplier;?>'>
                                    </div>
                                    <div class='col col-4' style="float:left">
                                    ...
                                    <div class='col col-4' style="float:left">
                                        ...
                                        <input type="text" class="form-control" name='attn' id='attn' value='<?php echo $list->attn;?>'>
                                    </div>
                                </div>
                                <div class="col col-12">
