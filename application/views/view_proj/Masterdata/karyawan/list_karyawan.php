                ...
                <h3 class='card-title' style='margin-top:10px'>
                  List Karyawan
                    ...
                    <span style='float:right !important'>
                      <a href="<?php echo base_url('Masterdata/tambah_karyawan')?>">
                      <button class='btn btn-warning'>Tambah Karyawan</button>
                      </a>
                    </span>
              </div>
              <div class='card-body'>
                              ...
                              echo "
                                  <Tr>
                                    ...
                                    echo"<td align='center'>
                                      <button class='btn btn-warning btn-sm' onclick='editKaryawan(".$i['teid'].");'><i class='fa fa-edit'></i></button>";
                                    if ( $i['ada_pakai'] > 0 ) {
                                     echo" <button class='btn btn-danger btn-sm' title='Karyawan Tidak Bisa Dihapus, data sudah dipakai' onclick='hapusKaryawan(".$i['teid'].",\"".$i['nama_karyawan']."\");' disabled><i class='fa fa-times'></i></button>";

                                    }
                                    else{

                                     echo" <button class='btn btn-danger btn-sm' title='Hapus Karyawan' onclick='hapusKaryawan(".$i['teid'].",\"".$i['nama_karyawan']."\");'><i class='fa fa-times'></i></button>";
                                    }
