...
function addSatuan(tsid,nama_satuan){
    ...
    var newCell = row.insertCell(3);
        newCell.align ="center";
        newCell.style.padding=".45rem";
        newCell.innerHTML = "<input type='text' class='form-control form-control-sm' style='text-align:center' name='konversi_detail[]' id='konversi_detail[]'/>";
