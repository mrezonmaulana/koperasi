        ...
        <div class="row">
          <div class="col-12">
            <div class='card'>
              ...
              <form class='form-horizontal' name='frm' id='frm' method='post' action="<?php echo base_url('masterdata/act_edit_perusahaan'); ?>">
                  <input type='hidden' name='tphid' id='tphid' value='<?php echo $list->tphid; ?>'/>
                  <div class='card-body'>
                    <div class='form-group-row'>
                             <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Perusahaan</label>
                              <div class="col-sm-12">
                                <input type="text" class="form-control" name='nama_perusahaan' id='nama_perusahaan' value='<?php echo $list->nama_perusahaan; ?>'>
                              </div>
                    </div>
                    <div class='form-group-row'>
                                  ...
                                  <option></option>
                                   <?php 
                                    foreach ($list_karyawan->result_array() as $key ) {
                                      ...
                                      $selected = "";
                                      if ( $key['teid'] == $list->teid ) {
                                         $selected = "selected='selected'";
                                      }

                                      echo "<option value='".$key['teid']."' ".$selected.">".$key['nama_karyawan']."</option>";
                                    }
                                   ?>
                                </select>
                              </div>
