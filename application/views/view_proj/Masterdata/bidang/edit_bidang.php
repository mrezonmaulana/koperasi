        ...
        <div class="row">
          <div class="col-12">
            <div class='card'>
              ...
              <form class='form-horizontal' name='frm' id='frm' method='post' action="<?php echo base_url('masterdata/act_edit_bidang'); ?>">
                  <div class='card-body'>
              
                  <div class='form-group-row'>
                           <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Bidang</label>
                            <div class="col-sm-12">
                              <input type="hidden" name="tbid" id="tbid" value="<?php echo $list->tbid; ?>"/>
                              <input type="text" class="form-control" name='nama_bidang' id='nama_bidang' value="<?php echo $list->nama_bidang; ?>">
                            </div>
                  </div>
                  </div>
