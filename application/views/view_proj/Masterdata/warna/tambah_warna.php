        ...
        <div class="row">
          <div class="col-12">
            <div class='card'>
              ...
              <form class='form-horizontal' name='frm' id='frm' method='post' action="<?php echo base_url('masterdata/act_add_warna'); ?>">
                  <div class='card-body'>
                  ...
                  <div class='form-group-row'>
                    <div class='col-6' style='float:left'>
                           <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Warna</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control form-control-sm" name='nama_warna' id='nama_warna' required="">
                            </div>
                      </div>
                      <div class='col-6' style='float:left'>
