...
<div id='previews'>
	...
	<form style='width:660px;margin:auto;' method='post' name='frm' id='frm' action="<?php echo base_url('Laporan/view_pinjaman_anggota')?>">
			...
			<?php 
			   ...
			   foreach ($list_report->result_array() as $key => $value) {
			   	echo "<tr>
			   		     ...
			   		     <td align='right' class='row_nominal'>".$value['nominal_pinjam']."</td>
			   		     <td align='center'>".$value['tenor']."</td>
			   		  </tr>";

			   		  $no++;
			   		  $total += $value['nominal_pinjam'];
			   }

			   if ( $total > 0 ) {
			   	   echo "<tr><td colspan='6' align='right'><b>TOTAL</b></td><td align='right' class='row_nominal'>".$total."</td><td></td>";
			   }
			?>
		</tbody>
	</table>
