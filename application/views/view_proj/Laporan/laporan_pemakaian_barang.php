...
<div id='previews'>
	...
	<form style='width:660px;margin:auto;' method='post' name='frm' id='frm' action="<?php echo base_url('Laporan/view_pemakaian_barang')?>">
		...
		<table width='100%' class='bdr1 pad'>
			...
			<tr>
				<th width='20%' style="text-align: left">No Pemakaian</th>
			...
			if ( $jml_data_detail > 0 ) {
				...
				foreach ($list_detail->result_array() as $key) {
					...
					if ( $first_row != $key['ttbid']) {
						...
						$kode_pemakaian_new = $kode_pemakaian;
						$subtotal = "<tr style='font-weight:bold;background:#ccc;font-style:oblique'
											><td colspan='8' align='right'> TOTAL ".$kode_pemakaian_new."</td>
				...
				$data_proj = explode(":",$first_row);
				$subtotal = "<tr style='font-weight:bold;background:#ccc;font-style:oblique'><td colspan='8' align='right'>TOTAL ".$kode_pemakaian."</td>
									<td align='center'>".$total_terima."</td>
									<td align='right' class='row_nominal'>".$totals."</td>
							 </tr>";
				$subtotal .= "<tr style='font-weight:bold;background:#ccc;font-style:oblique'><td colspan='8' align='right'>TOTAL SEMUA</td>
