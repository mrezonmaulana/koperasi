...
function addAjuan(){
  ...
  var newCell = row.insertCell(0);
    ...
    var newCell = row.insertCell(1);
        ...
        newCell.innerHTML = "<input type='text' name='desc[]' id='desc[]' class='form-control form-control-sm'/>";

        var newCell = row.insertCell(2);
        newCell.align ="center";
        newCell.innerHTML = "<input type='text' name='nom_ajuan[]' id='nom_ajuan["+lastRow+"]' class='form-control form-control-sm' style='text-align:right' onblur='hitungTotal();'/>";
...
var newCell = row.insertCell(0);
      newCell.innerHTML = "<input type='hidden' name='tpid[]' id='tpid[]' class='form-control form-control-sm' value='"+tpid+"'/><input type='hidden' name='sisa_set_brg[]' id='sisa_set_brg[]' value='"+anggaran+"'/>"+nama_project;

  var newCell = row.insertCell(1);
      newCell.align ="right";
      newCell.innerHTML = "<input type='hidden' name='anggaran[]' id='anggaran["+lastRow+"]' class='form-control form-control-sm' value='"+anggaran+"'/>"+new_anggaran;

      /*var newCell = row.insertCell(2);
      newCell.align ="right";
      newCell.innerHTML = "<input type='hidden' name='biaya_barang[]' id='biaya_barang["+lastRow+"]' class='form-control form-control-sm' value='"+biaya_barang+"'/>"+new_biaya_barang;*/
...
function chkform(){
    ...
    var is_out  = $("select[name='is_out'] option:selected").val();
  
    var total_ajuan_proj = backToNormal(document.getElementById('total_ajuan_project'));
    


    if ( parseFloat(total_ajuan_proj) <= 0 ) {

      alert('Total Ajuan Kas Tidak Boleh 0');
    ...
    var ajuan_kas  = backToNormal(document.getElementById('total_ajuan_project'));
        ...
        if(confirm('Apakah anda yakin akan memproses ajuan ini ?')) {
            $.post("<?php echo base_url('Ajuan/act_add_ajuan');?>",{tgl_ajuan:tgl_ajuan,total_ajuan_proj:total_ajuan_proj,arrajuan:JSON.stringify(arr_ajuan),keterangan:keterangan,is_out:is_out},function(data){
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class='fa fa-hands-helping'></i> Ajuan Kas</h1>
          </div><!-- /.col -->
                              ...
                              <div class='col' style="float:left">
                                  ...
                                  <label class="col col-form-label">Tanggal Ajuan</label>
                                    <div class="input-group">
                                     ...
                                     <input type="text" class="form-control form-control-sm float-right" name="tgl_ajuan" id="tgl_ajuan">
                                    </div>
                                  </div>
                                  <div class="col-3"  style='float:left'>
                                  <label class="col col-form-label">Tipe Biaya</label>
                                       <select name='is_out' id='is_out' class="form-control form-control-sm">
                ...
                <div class='card'>
                      <div class='card-body'>
                        <div class='col-6' style='float:left'>
                          ...
                          <input type='text' class='form-control form-control-sm' value="Rp. 0" id="total_nilai_kontraknya" style='text-align: right' readonly=""/>
                        </div>
                        <div class='col-6' style='float:left'>
                          <label>Total Biaya Barang</label>
                          <input type='text' class='form-control form-control-sm' value="Rp. 0" id="total_nilai_barangnya"  style='text-align: right'readonly=""/>
                        </div>
                       <!--  <div class='col-4' style='float:left'>
                          <label>Sisa</label>
                          <input type='text' class='form-control form-control-sm' id='sisa_biaya' readonly="" value="Rp. 0" />
                        </div> -->
                      </div>
                    </div>
                </div>
                    ...
                    <div class='card'>
                      <div class='card-header'>
                        ...
                        <span style='float:right'>
                          <button class='btn btn-sm btn-warning' onclick="addAjuan()"><i class='fa fa-plus'></i> Tambah Baris</button>
                        </span>
                      </div>
                      <form class='form-horizontal' name='frm' id='frm' method='post' action="#">
                          ...
                          <div class='card-body'>
                             <div class='col' hidden>
                               <label>Sisa Sebelum Ajuan Kas Project</label>
                                  <input type='text' class='form-control form-control-sm' id='sisa_biaya' readonly="" value="Rp. 0"  style="text-align: right" />
                             </div>
                             <div class='col'>
                               <label>Total Ajuan Kas</label>
                                  <input type='text' class='form-control form-control-sm' id='total_ajuan_project' readonly="" value="Rp. 0"  style="text-align: right" />
                             </div>
                             <div class='col' hidden>
                               <label>Sisa Setelah Ajuan Kas Project</label>
                                  <input type='text' class='form-control form-control-sm' id='sisa_biaya_project' readonly="" value="Rp. 0"  style="text-align: right" />
                             </div>
                          </div>
                         <div class='card-footer'>
                         <input type='button' class='btn btn-sm btn-primary' value='Proses Ajuan' onclick="chkform();"/>
                        </div>
                       </form>
                      </div>
                  </div>
